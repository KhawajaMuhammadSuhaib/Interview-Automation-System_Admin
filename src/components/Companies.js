...
export const Companies = () => {
    ...
    useEffect(() => {
        customerService.getCompanies(user.token).then(data => { setLoading1(false); setCustomer1(data) });
    ...
    const statusBodyTemplate = (data) => {
        return (
            <>
                ...
                {
                    data.userID.subscribed ?
                        <span className={`customer-badge status-qualified`}>Subscribed</span>
                        :
                        <span className={`customer-badge status-unqualified`}>Not Subscribed</span>
            ...
            <div className="col-12">
                <div className="card">
                    <DataTable value={customer1} paginator className="p-datatable-customers" rows={10} dataKey="id" rowHover
                        ...
                        <Column field="country.name" header="Email" sortable body={countryBodyTemplate}></Column>
